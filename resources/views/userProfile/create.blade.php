                ...
                <div class="card-body">
                    <form method="POST" action="/userProfile" name="update-profile">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('department') is-invalid @enderror" name="department" value="" required autocomplete="department" autofocus required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('department_bangla') is-invalid @enderror" name="department_bangla" value="" required autocomplete="department_bangla" autofocus required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('designation') is-invalid @enderror" name="designation" value="" required autocomplete="designation" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('designation_bangla') is-invalid @enderror" name="designation_bangla" value="" required autocomplete="designation_bangla" autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('contact_no') is-invalid @enderror" name="contact_no" value="" required autocomplete="contact_no" autofocus>
                            </div>
                        </div>
