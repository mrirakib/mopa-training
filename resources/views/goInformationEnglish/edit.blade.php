   ...
   <div class="row justify-content-center">
      <div class="col-md-12">
         <div class="card">
            ...
            @endif
            <div class="card-header"> GO Information Setting Update(English)</div>
            <div class="card-body">
               <form name="goInformation-update" action="/goInformationEnglish/{{$goInformation->id}}" method ="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
                  <div class="row">
                  @php
